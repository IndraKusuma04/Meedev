...
if(isset($_POST['simpan'])){
	...
	if ($sql){
		...
		echo "<script> alert('Data Berhasil Di Update'); window.location = 'index.php?page=order' </script>";
	}else {
		echo "<script> alert('Data Gagal Di Update'); window.location = index.php?page=order' </script>";
	}
}
