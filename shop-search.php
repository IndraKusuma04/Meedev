		...
		<div class="row">
			<div class="col-md-3">
				...
				<div class="widget product-category">
					...
					<?php
						include "koneksi.php";
						$query7 = mysqli_query($koneksi,"SELECT * FROM tb_jenis WHERE NOT idJenis='J-00002'");
						while($rows7 = mysqli_fetch_array($query7)){
					?>
					  	<div class="panel panel-default">
						    <div class="panel-heading" role="tab" id="headingOne">
						      	<h4 class="panel-title">
						        	<a role="button" href="?page=shop-search&id=<?php echo $rows7['idJenis'] ?>">
						          	<?php echo $rows7['jenis'];?>
						        	</a>
						      	</h4>
						    </div>
			...
			<div class="col-md-9">
				...
				<?php
					include "koneksi.php";
					$idjenis = $_GET['id'];
					$query = mysqli_query($koneksi,"SELECT * FROM tb_barang WHERE idJenis='$idjenis'");
