...
<div class="page-wrapper">
	...
	<div class="widget widget-latest-post">
		<h4 class="widget-title">Latest Posts</h4>
			<?php
				include "koneksi.php";
                $query2 = mysqli_query($koneksi,"SELECT a.*, b.jenis FROM tb_berita a LEFT JOIN tb_jenis b on a.kategoriBerita=b.idJenis");
				while($rows2 = mysqli_fetch_array($query2)){
			?>
		<div class="media">
			<a class="pull-left" href="?page=blogsingle">
				<img class="media-object" src="admin-mcsci/dist/img/<?php echo $rows2['foto']; ?>" alt="Image">
			</a>
			<div class="media-body">
				<h4 class="media-heading"><a href="?page=blogsingle"><?php echo $rows2['namaBerita']; ?></a></h4>
				<p>
					<?php
			...
			<div class="col-md-8">
        		...
        		<div class="post">
					<div class="post-media post-thumb">
						<a href="?page=blogsingle">
							<img src="admin-mcsci/dist/img/<?php echo $rows['foto']; ?>" alt="">
						</a>
					</div>
					<h2 class="post-title"><a href="?page=blogsingle"><?php echo $rows['namaBerita']; ?></a></h2>
					<div class="post-meta">
						<ul>
							<li>
					...
					<div class="post-content">
						...
						<a href="?page=blogsingle" class="btn btn-main">Continue Reading</a>
					</div>
